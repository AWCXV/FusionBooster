...
def main():
    ...
    output_path = './outputs_enhancedMUFusion_meif_rgb/';
    ...
    out_c = 1
    mode = 'L'
    model_path_ReconFuse = "./models/MEIF/ASE.model"
    model_path_ReconInfrared = "./models/MEIF/InformationProbe_ir.model"
    model_path_ReconVisible = "./models/MEIF/InformationProbe_vis.model"
    model_path_MUFusion = "./models/MEIF/MUFusion.model"
