...
<img width="20" src="images/task.png"> IVIF task:
```
python test_e2e_IVIF_rgb.py
```

<img width="20" src="images/task.png"> MEIF task (to do):

```
python xxx.py
```

<img width="20" src="images/task.png"> MFIF task:
...
<img width="20" src="images/task.png"> IVIF task (Backbone: DDcGAN)
...
<img width="20" src="images/task.png"> MFIF task (to do)
...
## <img width="32" src="images/train.png"> Train

<img width="20" src="images/task.png"> IVIF task (Backbone: DDcGAN)

<img width="20" src="images/dataset.png"> Dataset:
